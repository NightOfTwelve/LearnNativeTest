...
* 'configure.py --cpu=arm64 --amalgamation'
*
* Target
*  - Compiler: D:\Android\Sdk\ndk\26.1.10909125\toolchains\llvm\prebuilt\windows-x86_64\bin\aarch64-linux-android28-clang++.cmd -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm64
*  - OS: windows
*/
...
#define BOTAN_LIB_LINK "-lcrypt32 -luser32 -lws2_32"
